...
public class TakeGpInterfaceCommand extends ChangeGpInterfaceCommand {
	/**
	 * Takes GP from a user and prints the result of the operation in JSON format.
	 ...
	 */
	public TakeGpInterfaceCommand(ReputationDB rdb, User user, double amount, MessageSender publicResultSender,
